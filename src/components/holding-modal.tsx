  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      ...
      >
        <TouchableOpacity 
          activeOpacity={1}
          style={{ backgroundColor: '#18181b', borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '85%' }}
        >
          ...
          <ScrollView style={{ padding: 20 }} keyboardShouldPersistTaps="handled">
            ...
            >
              {loading ? <ActivityIndicator color="#052e16" /> : <Text style={{ fontSize: 14, fontWeight: '900', color: '#052e16' }}>{isEdit ? '수정' : '추가'}</Text>}
            </TouchableOpacity>
      ...
      <Modal visible={showDeleteConfirm} transparent animationType="fade">
        ...
        >
          <TouchableOpacity 
            activeOpacity={1}
            style={{ backgroundColor: '#18181b', borderRadius: 24, padding: 24, width: '80%', maxWidth: 320 }}
          >
            <Text style={{ fontSize: 18, fontWeight: '900', color: '#f4f4f5', textAlign: 'center', marginBottom: 8 }}>삭제 확인</Text>
            <Text style={{ fontSize: 13, color: '#71717a', textAlign: 'center', marginBottom: 20 }}>{isCash ? '현금 자산' : ticker}이 완전히 삭제됩니다.</Text>
